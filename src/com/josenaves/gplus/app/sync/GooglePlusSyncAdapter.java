...
public class GooglePlusSyncAdapter extends AbstractThreadedSyncAdapter {
	
	private final String LOG_TAG = GooglePlusSyncAdapter.class.getSimpleName();
	
	public GooglePlusSyncAdapter(Context context, boolean autoInitialize) {
